...
const RChart = RechartsLineChart as any
      ...
      <RContainer width="100%" height="100%">
        <RChart data={data} margin={{ top: 5, right: 10, left: 10, bottom: 0 }}>
          ...
          {categories.map((cat, i) => (
            <RLine key={cat} type={curveType} dataKey={cat} stroke={colors[i % colors.length]} strokeWidth={2} dot={false} connectNulls={connectNulls} />
          ))}
        </RChart>
      </RContainer>
    </div>
